function PrintBill({
  ...
  const allItems = roomOrders.flatMap(order => order.items);
      ...
      <div className="space-y-2">
        ...
        <div>
          <div className="flex justify-between gap-2">
            <p>Room ({nights} nights)</p>
            <p>{nights} x {rate} = {nights*rate}</p>
          </div>

          <p className="text-[11px] text-gray-600">({room.capacity} beds)</p>
        </div>
